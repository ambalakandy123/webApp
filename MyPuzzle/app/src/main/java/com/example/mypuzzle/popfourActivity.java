...
public class popfourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popfour);
    ...
    public void on_click_image(View v){
        ...
        //value of temp similar to com.jc165984.puzzle:id/btnp
        ...
        if (num_of_clicks == 1) {
            ...
            if (Arrays.equals(correct_id_seq, rand_id_seq)) {
                ...
                mp.start();
                //display the message
                CharSequence text = "Popaye Congrats you won in"+time_to_solve_puzzle+" Seconds";
    ...
    private void test_db(){
        ...
        myDB.insertPlayer(MessageText, 40, 1, "d");
