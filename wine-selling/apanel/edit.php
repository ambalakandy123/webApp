...
if (isset($_POST['update'])) {
  ...
  $image = $_POST['image'];
  $price = $_POST['price'];
  $query = "UPDATE products set title = '$title', description = '$description',image = '$image',price = '$price' WHERE id=$id";
  ...
  <div class="row">
    <div class="col-md-4 mx-auto">
      ...
      <form action="edit.php?id=<?php echo $_GET['id']; ?>" method="POST">
        ...
        <textarea name="price" class="materialize-textarea form-control" cols="30" rows="10" required><?php echo $price;?></textarea>
        </div>
