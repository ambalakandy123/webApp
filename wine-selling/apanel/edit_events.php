...
if (isset($_POST['update'])) {
  ...
  $image = $_POST['image'];
  $query = "UPDATE events set title = '$title', description = '$description',image = '$image' WHERE id=$id";
  mysqli_query($conn, $query);
  $_SESSION['message'] = 'events Updated Successfully';
...
<div class="container p-4">
  <div class="row">
    <div class="col-md-4 mx-auto">
      <div class="form">
      <form action="edit_events.php?id=<?php echo $_GET['id']; ?>" method="POST">
