...
ALTER TABLE theatere_row ADD CONSTRAINT theatere_row_pk PRIMARY KEY ( row_id );
...
ALTER TABLE seat
    ADD CONSTRAINT seat_theatere_row_fk FOREIGN KEY ( row_id )
        REFERENCES theatere_row ( row_id );

ALTER TABLE theatere_row
    ADD CONSTRAINT theatere_row_theatre_fk FOREIGN KEY ( theatre_id )
        REFERENCES theatre ( theatre_id );
